...
$(OUT_HTML): $(HTML_PAGES) $(BLOG_PAGES:.m4=.html) src/articles.html style.css
...
$(OUT_GMI): $(GMI_PAGES) $(BLOG_PAGES:.m4=.gmi) src/articles.gmi
...
clean:
	rm -f $(HTML_PAGES) $(BLOG_PAGES:.m4=.html) src/articles.html
	rm -f $(GMI_PAGES) $(BLOG_PAGES:.m4=.gmi) src/articles.gmi
